...
print(awful.util.getdir("config"))
...
local lock_img = gears.filesystem.get_configuration_dir() .. "/wallpaper" .. "/arch_splash.png"
...
apps = {
   ...
   lock = "i3lock -i " .. lock_img,
   screenshot = "spectacle",
   filebrowser = "thunar",
   browser = "firefox",
   gnus = "emacs --name gnus -f gnus",
...
-- Set keyboard layout
os.execute("setxkbmap -layout us -variant altgr-intl")
...
-- Highlight client border when focused
